...
// Create or update supplier profile - COMPLETE VERSION
  ...
  handler: async (ctx, args) => {
    ...
    if (!existingSupplier) {
      ...
      const supplierId = await ctx.db.insert("suppliers", {
        ...
        documents: [],
        status: "inactive",              // ✅ Must be active/inactive/suspended
        deliveryRadius: 50,              // 50km default
        baseTransportCost: 500,          // ✅ Required field
        perKmCost: 50,                   // ✅ Required field
        capacity: 1000,                  // ✅ Required field - max units
      });
